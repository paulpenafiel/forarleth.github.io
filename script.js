...
//-> Function that set up the up paper of the sobree.
...
function sobre_transition() {
  ...
  document
    ...
    .removeEventListener("click", sobre_transition);
...
function sticker() {
  ...
  document
    .querySelector(".js-up-paper")
    .addEventListener("click", sobre_transition);
